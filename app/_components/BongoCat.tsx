...
export default function BongoCat() {
  ...
  useEffect(() => {
    ...
    notes.forEach((n) => {
      n.parentElement?.appendChild(n.cloneNode(true));
      n.parentElement?.appendChild(n.cloneNode(true));
    });

    const pawRightUp = el.querySelector(sel('.paw-right .up')) as HTMLElement;
    const pawRightDown = el.querySelector(sel('.paw-right .down')) as HTMLElement;
    ...
    tl.add(animatePaw(pawLeftUp), 'start')
      .add(animatePaw(pawRightDown), 'start')
      .add(animatePaw(pawLeftDown), 'start+=0.19')
      .add(animatePaw(pawRightUp), 'start+=0.19')
      .timeScale(1.6);
    tlRef.current = tl;
    ...
    const colorizer = gsap.utils.random([
      'var(--green)', 'var(--pink)', 'var(--blue)',
      'var(--orange)', 'var(--cyan)', '#a3a4ec', '#67b5c0', '#fd7c6e',
    ], true);
    const rotator = gsap.utils.random(-50, 50, 1, true);
    const dir = (amt: number) => `${gsap.utils.random(['-', '+'] as const)}=${amt}`;
  ...
  return (
    <div
      ...
      style={{ maxHeight: 'clamp(200px, 35vh, 350px)' }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 783.55 354.91"
        className="w-full h-full"
        style={{ maxWidth: 'clamp(300px, 60vw, 600px)', overflow: 'visible' }}
      >
        <g id="bongo-cat">
          <g className="head">
          ...
          <g className="music music-right">
            ...
            <g className="note"><polyline points="388.2 73.6 388.2 34.6 354.9 42.6 354.9 82.4" /><path d="M388.2,74.1c0-3-4.4-5.6-8.1-5.8s-9.2,2.8-9.1,6,4.6,5.6,8.6,5.6S388.2,77.3,388.2,74.1Z" /><path d="M354.9,81.9c0-3.1-4.4-5.7-8.2-5.9s-9.3,2.8-9.2,6,4.7,5.7,8.7,5.7S354.9,85.1,354.9,81.9Z" /><line x1="354.9" y1="48.4" x2="388.2" y2="40.3" /><line x1="354.9" y1="54.6" x2="388.2" y2="47" /></g>
          ...
          <g className="music music-left">
            ...
            <g className="note"><polyline points="646.5 148.5 646.5 109.4 613.2 117.4 613.2 157.2" /><path d="M646.5,149c0-3.1-4.4-5.7-8.1-5.8s-9.2,2.7-9.1,5.9,4.7,5.6,8.6,5.6S646.5,152.1,646.5,149Z" /><path d="M613.2,156.7c.1-3.1-4.4-5.7-8.2-5.8s-9.3,2.7-9.2,6,4.7,5.6,8.7,5.6S613.2,159.9,613.2,156.7Z" /><line x1="613.2" y1="123.2" x2="646.5" y2="115.1" /><line x1="613.2" y1="129.4" x2="646.5" y2="121.8" /></g>
            <g className="note"><g><path d="M636.6,152.9c0-3.2-4.4-5.8-8.2-5.9s-9.3,2.8-9.3,6,4.8,5.7,8.7,5.7S636.6,156.1,636.6,152.9Z" /><line x1="636.6" y1="152.9" x2="636.6" y2="106.6" /><path d="M636.6,106.8a33.2,33.2,0,0,0,3.6,7.8c3.8,5.7,7.6,6.9,8.9,11.5a13.3,13.3,0,0,1-.9,8.4" /></g><g><path d="M636.6,152.9c0-3.2-4.4-5.8-8.2-5.9s-9.3,2.8-9.3,6,4.8,5.7,8.7,5.7S636.6,156.1,636.6,152.9Z" /><line x1="636.6" y1="152.9" x2="636.6" y2="106.6" /><path d="M636.6,106.8a33.2,33.2,0,0,0,3.6,7.8c3.8,5.7,7.6,6.9,8.9,11.5a13.3,13.3,0,0,1-.9,8.4" /></g></g>
          </g>
        </g>
      </svg>
    </div>
